          ...
          <div className="flex justify-between items-end mb-8">
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-[#D8B45A]">
                  Explore Sri Lanka
                </span>
              </div>
          ...
          <ScrollReveal>
            <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-16 text-center">
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#faf8f5] border border-gray-100">
                <span className="material-symbols-outlined text-[#0f1f3d]/30 text-2xl">villa</span>
              </div>
      ...
      <section className="px-4 md:px-16 max-w-[1280px] mx-auto mb-24">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <ScrollReveal direction="left" delay={0.05}>
            <div className="hover-lift rounded-2xl bg-white border border-gray-100 shadow-sm p-8 flex flex-col gap-5 h-full">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-[#D8B45A]">For Travellers</p>
          ...
          <ScrollReveal direction="right" delay={0.05}>
            <div
              className="rounded-2xl border border-[#D8B45A]/20 shadow-sm p-8 flex flex-col gap-5 h-full"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-[#D8B45A]">For Hosts</p>
      ...
      <section className="px-4 md:px-16 max-w-[1280px] mx-auto mb-24">
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden px-10 py-16 flex flex-col md:flex-row items-center justify-between gap-10"
            style={{ background: "linear-gradient(135deg, #060f22 0%, #0f1f3d 50%, #14295a 100%)" }}>

            {/* Decorative concentric rings */}
            <div className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full border border-[#D8B45A]/8" />
            <div className="pointer-events-none absolute -right-14 -top-14 h-64 w-64 rounded-full border border-[#D8B45A]/8" />
            <div className="pointer-events-none absolute -right-4 -top-4 h-40 w-40 rounded-full border border-[#D8B45A]/10" />
            {/* Left glow */}
            <div className="pointer-events-none absolute -left-20 top-1/2 -translate-y-1/2 h-48 w-48 rounded-full bg-[#1D63D8]/12 blur-3xl" />
            ...
            <div className="relative z-10 text-center md:text-left">
              ...
              <p className="text-[#D8B45A] text-[10px] font-bold tracking-[0.22em] uppercase mb-3">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-3 shrink-0">
              <Link
                href="/signup"
                className="bg-[#D8B45A] text-[#0f1f3d] font-bold px-8 py-3.5 rounded-full hover:bg-[#e8c96a] transition-colors text-sm tracking-wide text-center shadow-[0_4px_20px_rgba(216,180,90,0.3)]"
              >
                Start Your Journey
              </Link>
              <Link
