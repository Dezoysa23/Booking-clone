    ...
    <main className="min-h-screen bg-[#F8F2E9]">
      ...
      <section className="bg-[#14213D] px-4 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-[#D9A94D] text-xs font-semibold tracking-widest uppercase mb-3">Host Pricing</p>
      ...
      <section className="border-t border-gray-100 bg-white px-4 py-16">
        <div className="mx-auto max-w-3xl">
          <h2 className="font-[family-name:var(--font-playfair-display)] text-2xl font-semibold text-[#14213D] text-center mb-10">
