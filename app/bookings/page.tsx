      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#D8B45A]">Your Journeys</span>
            </div>
        ...
        {bookings.length > 0 ? (
          <div className="space-y-4">
            {bookings.map((booking) => {
              ...
              return (
                <div
                  key={booking.id}
                  className="rounded-2xl bg-white border border-gray-100 shadow-sm overflow-hidden hover:shadow-md hover:border-[#D8B45A]/20 transition-all duration-200"
                >
                  {/* Status top stripe */}
                  <div
                    className={`h-1 ${
                      status === "CONFIRMED" ? "bg-emerald-400" :
                      status === "CANCELLED" ? "bg-red-400" : "bg-[#123EAF]"
                    }`}
                  />
                  ...
                  <div className="px-6 py-5">
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                      {[
                        ...
                        <div key={label} className="rounded-xl bg-[#faf8f5] border border-gray-100 p-4 flex items-start gap-3">
                          <span className="material-symbols-outlined text-[#071B63]/35 text-base mt-0.5">{icon}</span>
                          <div>
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-between gap-4 rounded-xl bg-[#0f1f3d] px-5 py-4">
                      <div>
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#D8B45A]">Total Paid</p>
          ...
          <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-16 text-center">
            <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-[#faf8f5] border border-gray-100">
              <span className="material-symbols-outlined text-[#0f1f3d]/25 text-4xl">luggage</span>
            </div>
            <h2 className="font-[family-name:var(--font-playfair-display)] text-2xl font-semibold text-[#0f1f3d]">
              No journeys yet
            </h2>
            ...
            <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                ...
                className="rounded-xl bg-[#0f1f3d] px-6 py-3 text-sm font-semibold text-white hover:bg-[#1a3060] transition-colors flex items-center gap-1.5"
              >
