...
export default function PearloraAuthVisual() {
  return (
    <div className="relative flex flex-col justify-between h-full w-full px-10 py-10 overflow-hidden select-none">
      ...
      {/* ── Background orbs ── */}
      <div className="auth-orb-1 pointer-events-none absolute -top-16 -left-10 h-72 w-72 rounded-full bg-[#1D63D8]/28 blur-3xl" />
      <div className="auth-orb-2 pointer-events-none absolute -bottom-12 -right-8 h-60 w-60 rounded-full bg-[#D8B45A]/12 blur-3xl" />
      <div className="auth-orb-3 pointer-events-none absolute top-2/5 -right-14 h-48 w-48 rounded-full bg-[#123EAF]/22 blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <span className="h-px w-10 bg-[#D8B45A]/45" />
            <span className="text-[#D8B45A] text-[10px] font-semibold tracking-[0.22em] uppercase">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(145deg, #0369a1 0%, #0891b2 35%, #1D63D8 65%, #0a4fa6 100%)",
            }}
          >
            {/* Light sheen */}
            <div
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/65 to-transparent px-4 py-3">
              <div className="flex items-center gap-0.5 mb-0.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <span key={i} className="text-[#D8B45A] text-xs leading-none">★</span>
                ))}
          ...
          >
            ...
            <div className="flex items-center justify-between pt-3 border-t border-white/10">
              <div>
                ...
                <p className="text-[#D8B45A] text-base font-bold tracking-tight">LKR 24,000</p>
              </div>
              <div className="bg-[#D8B45A] text-[#071B63] text-[11px] font-bold px-3.5 py-1.5 rounded-lg tracking-wide">
                Book Now →
              </div>
            </div>
          </div>
        ...
        {TRUST_BADGES.map((badge) => (
          <div key={badge.label} className="flex items-center gap-3">
            <div className="h-9 w-9 shrink-0 rounded-xl bg-white/8 border border-white/10 flex items-center justify-center">
              <span className="material-symbols-outlined text-[#D8B45A] text-base">{badge.icon}</span>
            </div>
            <div>
