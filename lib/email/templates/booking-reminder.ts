...
export async function sendBookingReminderEmail(
  ...
  const { toEmail, toName, bookingId, propertyName, checkIn, checkOut, guests } = params;
...
<head>
  ...
  <title>Check-in Reminder — Pearlora</title>
</head>
<body style="margin:0;padding:0;background:#faf8f5;font-family:Georgia,serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#faf8f5;padding:40px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;max-width:600px;width:100%;">
        ...
        <!-- Header -->
        <tr>
          <td style="background:linear-gradient(135deg,#D8B45A,#c9a84c);padding:32px 40px;text-align:center;">
            <p style="margin:0 0 4px;color:rgba(15,31,61,0.7);font-size:11px;letter-spacing:0.18em;text-transform:uppercase;font-family:Arial,sans-serif;">Pearlora · Reminder</p>
            <h1 style="margin:0;color:#0f1f3d;font-size:26px;font-weight:600;">Your Stay is Tomorrow!</h1>
            <p style="margin:8px 0 0;color:rgba(15,31,61,0.6);font-size:14px;font-family:Arial,sans-serif;">Just a friendly check-in reminder.</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6;font-family:Arial,sans-serif;">
              This is a reminder that your stay at <strong style="color:#0f1f3d;">${propertyName}</strong> begins <strong style="color:#0f1f3d;">tomorrow</strong>. We hope you have a wonderful trip!
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
              <tr style="background:#faf8f5;">
                <td style="padding:12px 20px;font-size:11px;letter-spacing:0.12em;text-transform:uppercase;color:#9ca3af;font-family:Arial,sans-serif;width:40%;">Property</td>
                <td style="padding:12px 20px;font-size:14px;font-weight:600;color:#111827;font-family:Arial,sans-serif;">${propertyName}</td>
              </tr>
              <tr>
                ...
                <td style="padding:12px 20px;font-size:14px;font-weight:600;color:#0f1f3d;font-family:Arial,sans-serif;border-top:1px solid #f3f4f6;">${formatDate(checkIn)}</td>
              </tr>
              <tr style="background:#faf8f5;">
            ...
            <p style="margin:28px 0 0;color:#9ca3af;font-size:12px;line-height:1.6;font-family:Arial,sans-serif;text-align:center;">
              Safe travels! Questions? <a href="mailto:support@pearlora.lk" style="color:#0f1f3d;">support@pearlora.lk</a>
            </p>
          </td>
        </tr>
  ...
  await sendEmail({
    to: toEmail,
    subject: `Reminder: Your stay at ${propertyName} is tomorrow!`,
    html,
  });
}
